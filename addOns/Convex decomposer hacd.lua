        ...
        if params then
            ...
            if #params.sel > 0 then
                ...
                for i = 1, #params.sel do
                    ...
                    sim.addLog(sim.verbosity_scriptinfos, string.format('Generating HACD convex decomposed equivalent shape (%i/%i)...', cnt, #params.sel)) 
...
function sysCall_init()
    ...
    if #sel == 0 or sim.getSimulationState() ~= sim.simulation_stopped then
        ...
        ui = simUI.create(
          [[<ui title="HACD Convex Decomposer" closeable="true" on-close="onClose" modal="true">
